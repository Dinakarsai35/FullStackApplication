...
dynamodb_table = dynamodb.Table('studentinfo')
...
def lambda_handler(event, context):
    ...
    try:
        ...
        if http_method == 'GET' and path == status_check_path:
            ...
            response = modify_student(body['student_id'], body['updateKey'], body['updateValue'])
        elif http_method == 'DELETE' and path == student_path:
            body = json.loads(event['body'])
            response = delete_student(body['student_id'])
        else:
